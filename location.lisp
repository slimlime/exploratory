...
(defun navigator ()
  ...
  (with-namespace :navigate
    ...
    (let ((dst (+ +screen-width-bytes+ *screen-memory-address*)))
      ...
      (LDY 10)
      (LDA.IZY :loc)
      (STA.ZP (lo-add '(:decompress-image . :data)))
      (INY)
      (LDA.IZY :loc)
      (STA.ZP (hi-add '(:decompress-image . :data)))
